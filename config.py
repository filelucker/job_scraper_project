...
COMPANY_BOARDS = {
    ...
    'Atlassian': {'ats': 'workday', 'token': 'atlassian.wd1.myworkdayjobs.com/wday/cxs/atlassian/Atlassian'},
    ...
    'Slack': {'ats': 'workday', 'token': 'https://salesforce.wd12.myworkdayjobs.com/slack'},
    'Zapier': {'ats': 'ashby', 'token': 'zapier'},
    'Zoom': {'ats': 'workday', 'token': 'https://zoom.wd5.myworkdayjobs.com/zoom'},
    ...
    'Bolt Technology': {'ats': 'lever', 'token': 'bolt'},
    ...
    'We Work Remotely': {'ats': 'weworkremotely', 'token': '*'},
